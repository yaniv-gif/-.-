...
const services = [
  {
    id: "01",
    title: "פרקטים וחיפויי רצפה",
    subtitle: "למינציה ועץ תלת־שכבתי",
    description: "התקנת כל סוגי הפרקט (למינציה, עץ מלא ותלת־שכבתי, פישבון) עם הקפדה על יישור תשתית הרצפה, פאנלים ישרים וגימור נקי בצמוד לקירות.",
  ...
  },
  {
    ...
    subtitle: "מתיחה והדבקה",
    description: "התקנת שטיחים מקיר לקיר בשיטת מתיחה (אמריקאית) או בהדבקה מלאה (הולנדית), להתאמה מושלמת ללא גלים ועמידות לאורך זמן.",
    image: "https://images.unsplash.com/photo-1534349762913-961f69056d64?q=80&w=1200&auto=format&fit=crop", // Changed image to carpet/texture
    waMessage: "היי, אשמח להצעת מחיר לשטיח מקיר לקיר"
  },
  {
    id: "03",
    title: "חידוש ותיקון פרקטים",
    subtitle: "תחזוקה והתאוששות",
    description: "תיקון פרקטים שנפגעו ממים או שרוטו, והחלפת לוחות עץ פגומים – מחזירים את הרצפה לחיים כאילו חדשה.",
    image: "https://images.unsplash.com/photo-1581850518616-bcb8077a2536?q=80&w=1200&auto=format&fit=crop",
    waMessage: "היי, יש לי צורך בחידוש/תיקון פרקט"
  }
];

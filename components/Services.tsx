...
const services = [
  {
    ...
    description: "התקנת כל סוגי הפרקטים (למינציה, עץ, פישבון). הקפדה על פילוס הרצפה, פאנלים ישרים וגימור נקי בקירות.",
  ...
  },
  {
    ...
    description: "חידוש דקים ישנים (ליטוש ושימון), תיקון פרקטים שנפגעו ממים, והחלפת לוחות פגומים. מחזירים לעץ את המראה הטבעי שלו.",

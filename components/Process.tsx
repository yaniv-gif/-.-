  ...
  const steps = [
    {
      num: "01",
      title: "מדידה ותכנון",
      desc: "מיפוי לייזר מדויק של הרצפה + בדיקת לחות בקירות. תכנון פריסת לוחות במחשב כדי למנוע פחת ולהבטיח סימטריה מושלמת."
    },
    {
      num: "02",
      title: "הכנת התשתית",
      desc: "חיטוי המשטח, יישור הרצפה עם מדה מתפלסת (כשצריך) והתקנת שכבת בידוד אקוסטית לבידוד רעשים מקסימלי."
    },
    {
      num: "03",
      title: "התקנת אומן",
      desc: "חיתוך מדויק והתאמה מושלמת סביב משקופים, תוך שימוש בדבק פולימרי ירוק. עבודה שקטה המכבדת את המרחב הביתי."
    },
    {
      num: "04",
      title: "מסירה בסטנדרט מלונאי",
      desc: "מסירה בסטנדרט מלונאי: שאיבה יסודית עם שואב תעשייתי, החזרת כל הרהיטים למקום, וגם הדרכה קצרה על תחזוקה נכונה של הרצפה.",
      isHighlight: true
    }
  ];

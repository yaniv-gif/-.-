  ...
  const faqs = [
    {
      ...
      answer: "לא חובה. בשיטת העבודה שלנו אנחנו עובדים חדר-חדר, כך שאתם לא חייבים לעזוב את הבית. אנחנו גם משתמשים בשואבי אבק תעשייתיים המחוברים לכלי החיתוך, כך שכמעט ולא מצטבר אבק. אפשר להמשיך לגור בבית בזמן ההתקנה ללא הפרעה גדולה."
    },
    {
    ...
    },
    {
      ...
      answer: "דירת 100 מ\"ר סטנדרטית (התקנת פרקט) אורכת בערך יומיים עד שלושה ימי עבודה מלאים - וזה כולל גם התקנת פנלים וספים. אנחנו מתחייבים ללוחות זמנים מדויקים ולא עוזבים את האתר עד לסיום מושלם של הפרויקט. בסיום העבודה תקבלו הדרכה על תחזוקה נכונה."
    },
    {
      question: "האם יש אחריות על העבודה?",
      answer: "כן. אנחנו נותנים אחריות של 5 שנים על ההדבקה וההתקנה (לא כולל בלאי טבעי או נזקי שימוש קיצוניים). בנוסף, יש לנו ביטוח צד ג' מלא שמכסה נזקים אפשריים במהלך העבודה. אתם מקבלים חשבונית מלאה ומסמכי אחריות בכתב."
    }
  ];
